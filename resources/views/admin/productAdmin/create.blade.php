        ...
        @include('admin.productAdmin.partials.heading')
            ...
            <div class="row setup-content" id="step-1">
                ...
                <input id="rank" type="number" class="form-control" name="rank"
                        ...
                        </div> <div class="form-group{{ $errors->has('quantity_available') ? ' has-error' : '' }} clearfix">
                            <label for="quantity_available" class="col-sm-4 control-label">Quantity Available</label>

                            <div class="col-sm-8">
                                <input id="quantity_available" type="number" class="form-control" name="quantity_available" value="{{ old('quantity_available') }}" required
                                       autofocus>
