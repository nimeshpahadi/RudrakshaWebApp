    ...
    <div class=" col-md-8 col-md-offset-2">
        ...
        <div class="box box-info clearfix pad">
            ...
            <div class="clearfix " align="right">
                {{Form::submit('Save Changes', array('class'=>'btn btn-primary btn-sm ','title'=>'Save the changes in the Category'))}}
                <a type="button" class="btn btn-warning  btn-sm" href="/admin/category/{{$cat_id->id}}">Cancel</a>
                {!! Form::close() !!}
            </div>
