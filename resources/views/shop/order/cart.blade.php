                                ...
                                @foreach($orderitem as $orders)
                                    <tr>
                                        <td class="goods-page-image">
                                            <a href="javascript:;">
                                                <img src="{{asset('storage/image/product')}}/{{$orders['image']}}"> </a>
                                        </td>
                                        ...
                                        <td class="goods-page-quantity count-input space-bottom">
                                            <input class="quantity" type="text" name="quantity" disabled value="{{$orders['quantity']}}"/>
                                        </td>
                                        ...
                                        <td class="goods-page-total">
                                            <strong><span></span>{{$x=$orders['quantity']*$orders['prodprice']+$orders['capprice']}}</strong>
                                        </td>
                                        <td class="del-goods-col">

                                            <a class=" fa fa-pencil" style="color: #2ab27b"  href="{{route('order.edit',$orders['id'])}}"></a>
                                    ...
                                    <div class="col-sm-12 coupon form-inline">
                                        <div class="col-sm-3 col-sm-offset-9 coupon-middle-right">
                                            ...
                                            <button  class="pull-right btn btn-primary update_cart"
                                                     onclick="return confirm('Are you sure you want to delete all cart item?');">Clear Shopping Cart
                                            </button>
